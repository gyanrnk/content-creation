...
# Provider: "edge" (free, natural, no key — DEFAULT) | "sarvam" | "elevenlabs" | "gtts"
# Edge-TTS = Microsoft neural voices, NotebookLM jaisi natural, bilkul free.
# Sarvam/ElevenLabs keys abhi expired hain; gTTS robotic fallback hai.
VOICE_PROVIDER = "edge"
