...
def _build_messages(topic: str, mode: str, num_segments: int, context: str = ""):
    ...
    user = (
        ...
        "*** WORD COUNT — HARD LIMIT: every voice_english must be 10 to 14 words. "
        "COUNT them. This is from REAL view data: our 26-second / 45-word videos got "
        "1,274 views, our 41-second / 100-word videos got 0-29. SHORT WINS — viewers "
        "swipe long ones. Over 14 words = the video dies. Do NOT try to fit the whole "
        "story in one line; pick the single most striking detail and cut everything "
        "else. Use EXACTLY ONE connector "
