...
def _build_messages(topic: str, mode: str, num_segments: int, context: str = ""):
    ...
    user = (
        ...
        "*** WORD COUNT — STRICT BAND: every voice_english must be 12 to 16 words. "
        "COUNT them. Under 12 words = a bare FRAGMENT (WRONG — boring, no story). "
        "Over 16 words = a RUN-ON (WRONG — video too long). Use EXACTLY ONE connector "
